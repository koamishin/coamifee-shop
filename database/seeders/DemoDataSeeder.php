...
final class DemoDataSeeder extends Seeder
{
    ...
    private function createDemoOrders(): void
    {
        ...
        $productsWithIngredients = ProductIngredient::query()->pluck('product_id')->unique()->toArray();

        // Create 50 demo orders over the last 30 days
        for ($i = 0; $i < 50; $i++) {
            $orderDate = Date::now()->subDays(random_int(1, 30));
            ...
            for ($j = 0; $j < $numItems; $j++) {
                ...
                $orderItem = OrderItem::query()->create([
                    ...
                    'price' => 0,
                    'notes' => random_int(0, 1) === 1 ? 'No sugar' : null,
                ]);
    ...
    private function createIngredientUsage(): void
    {
        ...
        foreach ($orderItems as $orderItem) {
            ...
            foreach ($productIngredients as $productIngredient) {
                ...
                IngredientUsage::query()->updateOrCreate([
