...
final class LowStockAlertWidget extends BaseWidget
{
            ...
            ->columns([
                ...
                TextColumn::make('current_stock')
                    ...
                    ->formatStateUsing(fn ($record): HtmlString => new HtmlString("
                        ...
                        number_format((float) $record->current_stock, 2).
                        "</span>
                        <span style='color: #6b7280; font-size: 0.85em; margin-left: 4px;'>".
                        $record->ingredient->unit_type->value.
                        '</span>
                    ')),
                TextColumn::make('min_stock_level')
                    ...
                    ->formatStateUsing(fn ($record): HtmlString => new HtmlString("
                        ...
                        number_format((float) $record->min_stock_level, 2).
                        "</span>
                        <span style='color: #6b7280; font-size: 0.85em; margin-left: 4px;'>".
                        $record->ingredient->unit_type->value.
                        '</span>
                ...
                TextColumn::make('shortage')
                    ...
                    ->formatStateUsing(fn ($record): HtmlString => new HtmlString("
                        <span style='color: #dc2626; font-weight: bold;'>".
                        number_format(max(0, (float) $record->min_stock_level - (float) $record->current_stock), 2).
                        "</span>
                        <span style='color: #6b7280; font-size: 0.85em; margin-left: 4px;'>".
                        $record->ingredient->unit_type->value.
                        '</span>
    ...
    {
        $shortage = max(0, (float) $record->min_stock_level - (float) $record->current_stock);
        $percentage = ($shortage / (float) $record->min_stock_level) * 100;
