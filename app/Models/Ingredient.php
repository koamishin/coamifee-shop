...
final class Ingredient extends Model
{
    ...
    {
        self::saving(function (Ingredient $ingredient): void {
     ...
     */
    protected function setUnitTypeAttribute($value): void
    {
     ...
     */
    protected function getUnitTypeAttribute($value): ?UnitType
    {
