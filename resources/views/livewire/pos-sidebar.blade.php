<aside
    class="w-80 bg-white/70 dark:bg-[#2a2520]/70 backdrop-blur-lg rounded-2xl shadow-md border border-[#e8dcc8] dark:border-[#3d3530] sticky top-24 flex flex-col">
                ...
                >
                    <div class="flex items-center gap-1.5">
                        <div class="w-6 h-6 rounded overflow-hidden bg-[#e8dcc8] dark:bg-[#4d4540] flex-shrink-0">
                            ...
                            @else
                                <div class="w-full h-full flex items-center justify-center">
                                    <svg class="w-3 h-3 text-[#8b7355] dark:text-[#b8a892]" fill="none"
                        ...
                        <div class="flex-shrink-0">
                            <svg class="w-3 h-3 text-[#c17a4a] opacity-0 group-hover:opacity-100 transition-opacity"
